...
// UUIDs in little-endian byte order (reversed from the human-readable string),
// as required by Adafruit's Bluefruit library.
// Human-readable: 12345678-1234-1234-1234-123456789abc / ...abd
uint8_t serviceUuid[16] = { 0xBC, 0x9A, 0x78, 0x56, 0x34, 0x12, 0x34, 0x12,
                             0x34, 0x12, 0x34, 0x12, 0x78, 0x56, 0x34, 0x12 };
uint8_t charUuid[16]    = { 0xBD, 0x9A, 0x78, 0x56, 0x34, 0x12, 0x34, 0x12,
                             0x34, 0x12, 0x34, 0x12, 0x78, 0x56, 0x34, 0x12 };
